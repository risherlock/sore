...
function [w, zn_d, znd_d, zxd] = feedforward_control(phy_params, ddxi, dxi, A, dt, zn_d, znd_d, zxd)
  % Physical params
  g = phy_params(1);
  m = phy_params(2);
  l = phy_params(3);
...
for t = 1:length(time)-1
  ...
  [w(:,t), zn_d, znd_d, zxd] = feedforward_control(phy_params, ddxi, dxi, A, dt, zn_d, znd_d, zxd);
...
w(:,end) = feedforward_control(phy_params, ddxi, dxi, A, dt, zn_d, znd_d, zxd);
